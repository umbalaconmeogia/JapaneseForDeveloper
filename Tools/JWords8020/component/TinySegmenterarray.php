...
// TODO: The result of input below is not the same as js version
...
class TinySegmenterarray{
    ...
    public function segment($input, $encoding = null){
        if(!$input){
            return array();
        }
        if(!$encoding){
